<script lang="ts">
  ...
  export let theme: "Default" | "Secondary" | "Success" | "Danger" = "Default";
  ...
  if (!classNames) {
    ...
    switch (theme) {
      ...
      case "Secondary": classNames += "text-zinc-400 bg-zinc-600 focus:bg-zinc-400 focus:text-white hover:bg-zinc-500"; break;
